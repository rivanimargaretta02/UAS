...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => RivanimargarettaDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Rivanimargaretta (6SIA11)'),
        ),
        body: LoginPage(),
      ),
    );
...
class RivanimargarettaDataTable extends StatefulWidget {
_RivanimargarettaDataTableState createState() => _RivanimargarettaDataTableState();
}

class _RivanimargarettaDataTableState extends State<Rivanimargaretta DataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Rivani margaretta- 6SIA11'),
      ),
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Rivani margaretta", ),
      DataMahasiswa(
          id: "Jenis Kelamin", namabarang: "Perempuan", ),
      DataMahasiswa(id: "Alamat", namabarang: "Jl.jamin ginting gg nangka 2 kwala bekala " ),
      DataMahasiswa(
